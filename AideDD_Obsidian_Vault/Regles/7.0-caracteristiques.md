...
- [[7.0-caracteristiques|Force]], mesure la puissance physique
- [[7.0-caracteristiques|Dextérité]], mesure l'agilité
- [[7.0-caracteristiques|Constitution]], mesure l'endurance
- [[7.0-caracteristiques|Intelligence]], mesure le raisonnement et la mémoire
- [[7.0-caracteristiques|Sagesse]], mesure la perception et l'intuition
- [[7.0-caracteristiques|Charisme]], mesurer la force de la personnalité

Est-ce qu'un personnage est musclé et perspicace ? Brillant et charmant ? Agile et robuste ? Les valeurs des caractéristiques définissent les qualités et les faiblesses d'une créature. Les trois principaux jets de dés du jeu (le jet de caractéristique, le jet de sauvegarde et le jet d'attaque) se basent sur les six valeurs des caractéristiques. [[0-regles|L'introduction]] décrit la règle de base derrière ces jets : lancer un d20, ajouter un modificateur de caractéristique provenant d'une des six caractéristiques, et comparer le total à l'objectif. Ce chapitre se concentre sur la façon d'utiliser les jets de caractéristique et les jets de sauvegarde, qui couvrent les activités fondamentales que les créatures tentent durant le jeu. Les règles pour les jets d'attaque sont dans le chapitre [[9.0-combat|Combat]].

## [[7.0-caracteristiques|Valeurs et modificateurs de caractéristique]]
...
## [[7.0-caracteristiques|Avantage et désavantage]]
...
Vous gagnez habituellement un avantage ou un désavantage grâce à l'utilisation de capacités spéciales, d'actions ou de sorts. L'[[0-historiques|inspiration]] peut également donner un avantage au personnage pour les jets liés à son trait, son idéal ou ses liens. Le MD peut également décider que les circonstances influent sur un jet dans un sens ou dans l'autre, et accorder en conséquence un avantage ou un désavantage.

## [[7.0-caracteristiques|Bonus de maîtrise]]

Les personnages ont un bonus de maîtrise déterminé par leur niveau, comme indiqué dans le chapitre de [[1-creation-de-perso|création de personnage]]. Les monstres possèdent également ce bonus, lequel est intégré dans leurs blocs de stat. Ce bonus est utilisé pour les jets de caractéristique, les jets de sauvegarde et les jets d'attaque.
...
## [[7.0-caracteristiques|Jets de caractéristique]]
...
## [[7.0-caracteristiques|Utiliser chaque caractéristique]]
...
### [[7.0-caracteristiques|Dextérité]]
...
**Que pouvez-vous voir ?** Pour déterminer si vous pouvez voir une créature ou un objet caché, il est important de savoir quelle est la visibilité dans la zone, qui peut être **réduite** ou **nulle** (voir [[8.0-aventure|Partir à l'aventure]]).
...
Selon l'armure que vous portez, vous pouvez ajouter tout ou partie de votre modificateur de Dextérité à votre classe d'armure (voir [[4-armures|Armures]]).

#### Initiative

Au début de chaque combat, vous lancez l'initiative en faisant un jet de Dextérité. L'initiative détermine l'ordre des tours des créatures en combat (voir [[9.0-combat|Combat]]).

### [[7.0-caracteristiques|Constitution]]
...
### [[7.0-caracteristiques|Intelligence]]
...
## [[7.0-caracteristiques|Jets de sauvegarde]]
