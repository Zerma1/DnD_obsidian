---
title: "Ensorceleur"
source: "https://www.aidedd.org/regles/classes/ensorceleur"
tags:
  - dnd5
  - regles
---
...
Vous pouvez concevoir rapidement un ensorceleur en suivant ces quelques suggestions. En premier lieu, le Charisme devrait être votre plus haute valeur de caractéristique, suivie par la Constitution. Ensuite, choisissez l'historique [[Ermite]]. Enfin, choisissez les sorts mineurs [*lumière*](dnd/sorts.php?vf=lumiere), *poigne électrique*, [*prestidigitation*](dnd/sorts.php?vf=prestidigitation) et [*rayon de givre*](dnd/sorts.php?vf=rayon-de-givre) en plus des sorts de niveau 1 [*bouclier*](dnd/sorts.php?vf=bouclier) et [*projectile magique*](dnd/sorts.php?vf=projectile-magique).
...
Pour pouvoir utiliser cette option de métamagie, le sort doit être incapable de cibler plus d'une créature au niveau auquel il est lancé. Par exemple, *[rayon de givre](dnd/sorts.php?vf=rayon-de-givre)* fonctionne avec cette option mais pas [*projectile magique*](dnd/sorts.php?vf=projectile-magique) ni [*rayon ardent*](dnd/sorts.php?vf=rayon-ardent).
...
## [[Ensorceleur\_1#voie|Origines magiques]]
...
### [[Ensorceleur\_1#draconique|Lignée draconique]]
...
### [[Ensorceleur\_1#sauvage|Magie sauvage]]
...
Traduit par puncho, 5hAmAhS, Maslow et blueace