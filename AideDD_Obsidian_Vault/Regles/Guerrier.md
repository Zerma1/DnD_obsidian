...
## [[Guerrier\_1#voie|Archétypes martiaux]]
...
### [[Guerrier\_1#maitre|Maître de guerre]]
...
Au niveau 3, vous gagnez la maîtrise d'un [[Outils|outil d'artisan]] de votre choix.
...
**Attaque menaçante**. Si vous touchez une créature lors d'une attaque avec une arme, vous pouvez dépenser un dé de supériorité pour tenter d’effrayer la cible. Ajoutez votre dé de supériorité aux dégâts, et la cible doit faire un jet de sauvegarde de Sagesse. En cas d'échec, la cible est [[États|effrayée]] jusqu'à la fin de votre prochain tour.
...
### [[Guerrier\_1#eldritch|Chevalier occulte]]
...
![Eldritch Knight](/assets/regles/classes/eldritch.jpg "Eldritch Knight")
