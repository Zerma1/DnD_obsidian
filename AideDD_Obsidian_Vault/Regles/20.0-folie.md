...
### Soigner la folie
Un sort d'*[[10.1-sorts|apaisement des émotions]]* peut supprimer les effets de la folie, tandis qu'un sort de *[[10.1-sorts|restauration partielle]]* peut débarrasser un personnage d'une folie de courte ou de longue durée. En fonction de la source de la folie, les sorts *[[10.1-sorts|délivrance des malédictions]]* et [[10.1-sorts|dissipation du mal]] peuvent également être efficaces. Un sort de [[10.1-sorts|restauration supérieure]] ou tout autre magie plus puissante est nécessaire pour guérir un personnage d'une folie à durée illimitée.
