...
#### [[22.0-temps-morts-xgte|Acheter un objet magique]]
...
#### [[22.0-temps-morts-xgte|Faire la fête]]
...
#### [[22.0-temps-morts-xgte|Fabriquer un objet]]
...
**Fabriquer un objet magique**. Créer un objet magique demande plus qu'un investissement en temps, en efforts et en matériaux. C'est un long processus qui demandera une ou plusieurs aventures afin de se procurer les matériaux rares et les connaissances nécessaires. Les [[14.6-Description|potions de guérison]]et les [[14.6-Description|parchemins de sort]] sont des exceptions aux règles qui suivent. Pour les *potions de guérison*, reportez-vous au paragraphe "Potions de guérison" dans cette section. Pour les *parchemins de sort*, reportez-vous à la section [[22.0-temps-morts-xgte|Écrire un parchemin de sort]].
...
Choisissez un monstre ou un lieu qui sera en rapport avec l'objet magique. Idéalement, ils partageront un lien élément ou une même nature. Par exemple, l'*[[14.6-Description|armure de matelot]]* pourrait demander l'essence d'une [[2-Description|sentinelle d'eau]]. Un *[[14.6-Description|bâton d’envoûtement]]* pourrait nécessiter la coopération d'un [[2-Description|arcanaloth]] particulier, qui acceptera d'aider les personnages s'ils complètent une tâche pour lui au préalable. Créer un *[[14.6-Description|bâton de surpuissance]]* pourrait nécessiter de trouver un bout d'une pierre ancienne qui aurait été touchée jadis par le dieu de la magie lui-même, pierre qui pourrait être gardée par un [[2-Description|androsphinx]] suspicieux.
...
**Potions de guérison**. Les [[14.6-Description|potions de guérison]]suivent un procédé de fabrication spécial qui est différent des autres objets magiques. Tout personnage qui maîtrise le kit d'herboriste peut les créer. Les ressources et le temps nécessaire sont décrits dans la table suivante.
...
#### [[22.0-temps-morts-xgte|Perpétrer un crime]]
...
#### [[22.0-temps-morts-xgte|Combat]]tre
...
#### [[22.0-temps-morts-xgte|Relaxation]]
...
#### [[22.0-temps-morts-xgte|Service religieux]]
...
#### [[22.0-temps-morts-xgte|Faire des recherches]]
...
#### [[22.0-temps-morts-xgte|Rédiger un parchemin de sort]]

![Parchemin magique](assets/intro/articles/UA/downtime3.jpg)Avec du temps et de la patience, un lanceur de sort peut coucher sur un parchemin ses connaissances, afin de créer un [[14.6-Description|parchemins de sort]].
...
#### [[22.0-temps-morts-xgte|Vendre un objet magique]]
...
#### [[22.0-temps-morts-xgte|Se former]]
...
#### [[22.0-temps-morts-xgte|Travailler]]
