---
title: "Outils"
source: "https://www.aidedd.org/regles/equipement/outils/"
tags:
  - dnd5
  - regles
---
...
| Chalemie | Shawm | 2 po | 500 g |
| Cor | Horn | 3 po | 1 kg |
| Cornemuse | Bagpipes | 30 po | 3 kg |
| Flûte | Flute | 2 po | 500 g |
| Flûte de pan | Pan flute | 12 po | 1 kg |
| Luth | Lute | 35 po | 1 kg |
| Lyre | Lyre | 30 po | 1 kg |
| Tambour | Drum | 6 po | 1,5 kg |
| Tympanon | Dulcimer | 25 po | 5 kg |
| Viole | Viol | 30 po | 500 g |
| *Jeux* | *Gaming set* |  |  |
| Dés | Dice set | 1 pa | - |
| Jeu d'échecs draconiques | Dragonchess set | 1 po | 250 g |
...
| Kit d'herboriste | Herbalism kit | 5 po | 1,5 kg |
| Kit de contrefaçon | Forgery kit | 15 po | 2,5 kg |
| Kit de déguisement | Disguise kit | 25 po | 1,5 kg |
| *Outils d'artisan* | *Artisan's tools* |  |  |
| Matériel d'alchimiste | Alchemist's supplies | 50 po | 4 kg |
| Matériel de brasseur | Brewer's supplies | 20 po | 4,5 kg |
| Matériel de calligraphe | Calligrapher's supplies | 10 po | 2,5 kg |
| Matériel de peintre | Painter's supplies | 10 po | 2,5 kg |
| Outils de bijoutier | Jeweler's tools | 25 po | 1 kg |
| Outils de bricoleur | Tinker's tools | 50 po | 5 kg |
| Outils de cartographe | Cartographer's tools | 15 po | 3 kg |
| Outils de charpentier | Carpenter's tools | 8 po | 3 kg |
| Outils de cordonnier | Cobblers' tools | 5 po | 2,5 kg |
| Outils de forgeron | Smith's tools | 20 po | 4 kg |
| Outils de maçon | Mason's tools | 10 po | 4 kg |
| Outils de menuisier | Woodcarver's tools | 1 po | 2,5 kg |
| Outils de potier | Potter's tools | 10 po | 1 kg |
| Outils de souffleur de verre | Glassblower's tools | 30 po | 2,5 kg |
| Outils de tanneur | Leatherworker's tools | 5 po | 2,5 kg |
| Outils de tisserand | Weaver's tools | 1 po | 2,5 kg |
| Ustensiles de cuisinier | Cook's utensils | 1 po | 4 kg |
| Outils de navigateur | Navigator's tools | 25 po | 1 kg |
| Outils de voleur | Thieves' tools | 25 po | 500 g |
| Véhicules (terrestres) | Vehicles (land) | \* | \* |
| Véhicules (aquatiques) | Vehicles (water) | \* | \* |

\* Voir [[Montures et véhicules]]
...
**Kit d'herboriste**. Ce kit contient une variété d'instruments, tels des pinces, un pilon, des sachets et des flacons que les herboristes utilisent pour créer des remèdes et des potions. Si vous maîtrisez le kit d'herboriste, vous ajoutez votre bonus de maîtrise à tous les jets de caractéristique pour identifier des herbes ou concocter des mélanges et des infusions. Maîtriser le kit d'herboriste est indispensable pour créer des potions de guérison et des antidotes.
