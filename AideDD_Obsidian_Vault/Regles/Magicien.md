---
title: "Magicien"
source: "https://www.aidedd.org/regles/classes/magicien/"
tags:
  - dnd5
  - regles
---
...
Vous pouvez concevoir rapidement un magicien en suivant ces quelques suggestions. En premier lieu, l'Intelligence devrait être votre plus haute valeur de caractéristique, suivie par la Constitution ou la Dextérité. Ensuite, choisissez l'historique [[Sage]]. Enfin, choisissez les sorts mineurs [*lumière*](dnd/sorts.php?vf=lumiere), *main de mage* et [*rayon de givre*](dnd/sorts.php?vf=rayon-de-givre) en plus des sorts de niveau 1 *[armure de mage](dnd/sorts.php?vf=armure-de-mage), [bouclier](dnd/sorts.php?vf=bouclier), [charme-personne](dnd/sorts.php?vf=charme-personne), [mains brûlantes](dnd/sorts.php?vf=mains-brulantes), [projectile magique](dnd/sorts.php?vf=projectile-magique)* et [*sommeil*](dnd/sorts.php?vf=sommeil) pour votre grimoire.
...
### [[Magicien\_1#divination|École de divination]]
...
**Compréhension supérieure.** Vous pouvez lire toutes les langues. **Vision dans le noir**. Vous gagnez vision dans le noir à 18 mètres.  
...
### [[Magicien\_1#enchantement|École d'enchantement]]
...
### [[Magicien\_1#evocation|École d'évocation]]
...
### [[Magicien\_1#illusion|École d'illusion]]
...
### [[Magicien\_1#invocation|École d'invocation]]
...
### [[Magicien\_1#necromancie|École de nécromancie]]
...
### [[Magicien\_1#transmutation|École de transmutation]]
...
**Restitution de vie**. Vous lancez le sort [*rappel à la vie*](dnd/sorts.php?vf=rappel-a-la-vie) sur une créature que vous touchez au moyen de la pierre du transmutateur, sans avoir besoin d'utiliser un emplacement de sort ou d'avoir le sort écrit dans votre livre de sorts.  
