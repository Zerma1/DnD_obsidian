...
source: "[https://www.aidedd.org/regles/liste-objets-magiques/](https://www.aidedd.org/dnd/omList.php)"
tags:
  - dnd5
  - regles
  - Objet_magique
...
- Vous pouvez utiliser l'amulette comme focaliseur d'incantation pour vos sorts d'occultiste.
...
• _[Amitié avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=amitie-avec-les-animaux)_ (sauvegarde DD 13)  
• _[Peur](https://www.aidedd.org/dnd/sorts.php?vf=peur)_ (sauvegarde DD 13), vous ne pouvez cibler que les bêtes qui ont une valeur d'Intelligence inférieure ou égale à 3  
• _[Communication avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-animaux)_  
...
**Anneau de contrôle de l'Air Élémentaire**. Vous pouvez dépenser 2 des charges de l'anneau pour lancer le sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ sur un élémentaire de l'air. De plus, lorsque vous tombez, vous descendez à une vitesse de 18 mètres par tour et ne subissez aucun dégât de chute. Vous pouvez également parler et comprendre l'aérien.  
...
• Vous pouvez lancer les sorts suivants depuis l'anneau, en dépensant le nombre de charges nécessaire : _[chaîne d'éclairs](https://www.aidedd.org/dnd/sorts.php?vf=chaine-d-eclairs)_ (3 charges), _[bourrasque](https://www.aidedd.org/dnd/sorts.php?vf=bourrasque)_ (2 charges), _[mur de vent](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-vent)_ (1 charge).  
**Anneau de contrôle de la Terre Élémentaire**. Vous pouvez dépenser 2 des charges de l'anneau pour lancer le sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ sur un élémentaire de la terre. De plus, vous pouvez vous déplacer sur des terrains difficiles composés de gravats, de rochers, ou de boue comme si c'étaient des terrains normaux. Vous pouvez également parler et comprendre le terreux.  
...
• Vous pouvez lancer les sorts suivants depuis l'anneau, en dépensant le nombre de charges nécessaire : _[façonnage de la pierre](https://www.aidedd.org/dnd/sorts.php?vf=faconnage-de-la-pierre)_ (2 charges), _[peau de pierre](https://www.aidedd.org/dnd/sorts.php?vf=peau-de-pierre)_ (3 charges), _[mur de pierre](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-pierre)_ (3 charges).  
**Anneau de contrôle du Feu Élémentaire**. Vous pouvez dépenser 2 des charges de l'anneau pour lancer le sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ sur un élémentaire du feu. De plus, vous avez la résistance aux dégâts de feu. Vous pouvez également parler et comprendre l'igné.  
...
• Vous pouvez lancer les sorts suivants depuis l'anneau, en dépensant le nombre de charges nécessaire : _[mains brûlantes](https://www.aidedd.org/dnd/sorts.php?vf=mains-brulantes)_ (1 charge), _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (2 charges), _[mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu)_ (3 charges).  
**Anneau de contrôle de l'Eau Élémentaire**. Vous pouvez dépenser 2 des charges de l'anneau pour lancer le sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ sur un élémentaire de l'eau. De plus, vous pouvez vous déplacer et rester sur les surfaces liquides comme si vous étiez sur la terre ferme. Vous pouvez également parler et comprendre l'aquatique.  
...
• Vous pouvez lancer les sorts suivants depuis l'anneau, en dépensant le nombre de charges nécessaire : _[création ou destruction d'eau](https://www.aidedd.org/dnd/sorts.php?vf=creation-ou-destruction-d-eau)_ (1 charge), _[contrôle de l'eau](https://www.aidedd.org/dnd/sorts.php?vf=controle-de-l-eau)_ (3 charges), _[tempête de grêle](https://www.aidedd.org/dnd/sorts.php?vf=tempete-de-grele)_ (2 charges), _[mur de glace](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-glace)_ (3 charge).  
...
Lorsque vous portez cette bague dans une zone de lumière faible ou de ténèbres, vous pouvez jeter _[lumières dansantes](https://www.aidedd.org/dnd/sorts.php?vf=lumieres-dansantes)_ et _[lumière](https://www.aidedd.org/dnd/sorts.php?vf=lumiere)_ depuis l'anneau à volonté. Lancer un de ces deux sorts depuis l'anneau nécessite une action.  
L'anneau a 6 charges pour les propriétés suivantes. L'anneau récupère 1d6 charges dépensées chaque jour à l'aube.  
**Lucioles**. Vous pouvez dépenser 1 charge par une action pour lancer _[lueurs féeriques](https://www.aidedd.org/dnd/sorts.php?vf=lueurs-feeriques)_ depuis l'anneau.  
...
Lorsque vous portez cet anneau, vous pouvez lancer le sort _[saut](https://www.aidedd.org/dnd/sorts.php?vf=saut)_ depuis l'anneau par une action bonus, à volonté, mais vous ne pouvez cibler que vous-même.  
...
Lorsque vous portez cet anneau, vous pouvez lancer le sort _[télékinésie](https://www.aidedd.org/dnd/sorts.php?vf=telekinesie)_ à volonté, mais vous ne pouvez cibler que des objets qui ne sont pas portés ou transportés.  

# Anneau de triple souhait

Anneau, légendaire

Lorsque vous portez cet anneau, vous pouvez utiliser une action pour dépenser une de ses 3 charges pour lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ depuis l'anneau. L'anneau devient non magique lorsque vous utilisez la dernière charge.  
...
Lorsque vous portez cette armure, vous obtenez un bonus à la CA. Le bonus est déterminé par sa rareté.  
...
Vous avez une résistance contre les dégâts non magiques tant que vous portez cette armure. De plus, vous pouvez utiliser une action pour vous immuniser aux dégâts non magiques pendant 10 minutes ou jusqu'à ce que vous ne portiez plus cette armure. Une fois que cette action spéciale est utilisée, elle ne peut être réutilisée avant la prochaine aube.  
...
**Malédiction**. Cette armure est maudite, un fait qui n'est révélé que lorsqu'un sort d'_[identification](https://www.aidedd.org/dnd/sorts.php?vf=identification)_ est lancé sur l'armure ou si vous vous liez à elle. Se lier à l'armure vous maudit jusqu'à ce que vous soyez ciblé par le sort _[délivrance des malédictions](https://www.aidedd.org/dnd/sorts.php?vf=delivrance-des-maledictions)_ ou une magie similaire ; retirer l'armure ne permet pas de mettre un terme à la malédiction. Tant que vous êtes maudit, vous avez une vulnérabilité face aux deux autres types de dégâts associés à cette armure (pas celui contre lequel l'armure vous confère une résistance).  

# Armure démoniaque

Armure (harnois), très rare (nécessite un lien)

Lorsque vous portez cette armure, vous gagnez un bonus de +1 à la CA, et vous pouvez comprendre et parler l'abyssal. En outre, les gantelets griffus de l'armure transforment vos attaques à mains nues en armes magiques qui infligent des dégâts tranchants, avec un bonus de +1 aux jets d'attaque et de dégâts et un dé de dégâts de 1d8.  
**Malédiction**. Une fois que vous avez enfilé cette armure maudite, vous ne pouvez plus l'ôter, sauf si vous êtes la cible du sort _[délivrance des malédictions](https://www.aidedd.org/dnd/sorts.php?vf=delivrance-des-maledictions)_ ou d'une magie similaire. Tant que vous portez l'armure, vous avez un désavantage aux jets d'attaque contre les démons et aux jets de sauvegarde contre leurs sorts et leurs capacités spéciales.  
...
**Propriétés aléatoires**. La baguette possède un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
...
**Sorts**. La baguette possède 7 charges. Tant que vous la tenez, vous pouvez utiliser une action pour dépenser 1 ou plusieurs de ses charges pour lancer l'un des sorts suivants (sauvegarde DD 18) : _[animation des morts](https://www.aidedd.org/dnd/sorts.php?vf=animation-des-morts)_ (1 charge), _[flétrissement](https://www.aidedd.org/dnd/sorts.php?vf=fletrissement)_ (2 charges), _[cercle de mort](https://www.aidedd.org/dnd/sorts.php?vf=cercle-de-mort)_ (3 charges), _[doigt de mort](https://www.aidedd.org/dnd/sorts.php?vf=doigt-de-mort)_ (3 charges), _[mot de pouvoir mortel](https://www.aidedd.org/dnd/sorts.php?vf=mot-de-pouvoir-mortel)_ (4 charges) ou _[communication avec les morts](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-morts)_ (1 charge). La baguette récupère 1d4 + 3 charges dépensées chaque jour à l'aube.  
...
Cette baguette possède 7 charges. Si vous la tenez, vous pouvez utiliser une action pour dépenser 1 ou plusieurs charges et lancer le sort _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (sauvegarde DD 15). Avec 1 charge, vous lancez la version de niveau 3 du sort. Vous pouvez augmenter le niveau de l'emplacement de sort de un pour chaque charge supplémentaire que vous dépensez.  
La baguette regagne 1d6 + 1 charges chaque jour à aube. Lorsque vous dépensez la dernière charge, lancez 1d20. Sur un 1, la baguette tombe en cendre et est détruite.  
...
Cette baguette possède 3 charges. Tant que vous tenez cette baguette, vous pouvez dépenser 1 charge au prix d'une action pour lancer le sort _[détection de la magie](https://www.aidedd.org/dnd/sorts.php?vf=detection-de-la-magie)_ depuis la baguette. La baguette récupère 1d3 charges dépensées chaque jour à l'aube.  

# Baguette de métamorphose

Baguette, très rare (nécessite un lien par un lanceur de sorts)

Cette baguette possède 7 charges. Si vous la tenez, vous pouvez utiliser une action pour dépenser 1 de ses charges et jeter le sort _[métamorphose](https://www.aidedd.org/dnd/sorts.php?vf=metamorphose)_ (sauvegarde DD 15).  
...
**Injonction**. Si vous tenez la baguette, vous pouvez utiliser une action pour dépenser 1 charge et ordonner à une autre créature de fuir ou de se mettre à plat ventre, comme avec le sort _[injonction](https://www.aidedd.org/dnd/sorts.php?vf=injonction)_ (sauvegarde DD 15).  
...
Cette baguette possède 7 charges. Si vous la tenez, vous pouvez utiliser une action pour dépenser 1 de ses charges et jeter le sort _[toile d'araignée](https://www.aidedd.org/dnd/sorts.php?vf=toile-d-araignee)_ (sauvegarde DD 15).  
La baguette récupère 1d6 + 1 charges dépensées chaque jour à l'aube. Lorsque vous dépensez la dernière charge, lancez un d20. Sur un 1, la baguette tombe en cendre et est détruite.  
...
**Sorts**. Lorsque vous tenez la baguette, vous pouvez utiliser une action pour dépenser des charges et lancer l'un des sorts suivants (sauvegarde DD 17) : _[immobilisation de monstre](https://www.aidedd.org/dnd/sorts.php?vf=immobilisation-de-monstre)_ (5 charges) ou _[immobilisation de personne](https://www.aidedd.org/dnd/sorts.php?vf=immobilisation-de-personne)_ (2 charges).  
...
|d100|Effet|
|---|---|
|01-05|Vous lancez le sort _[lenteur](https://www.aidedd.org/dnd/sorts.php?vf=lenteur)_.|
|06-10|Vous lancez le sort _[lueurs féeriques](https://www.aidedd.org/dnd/sorts.php?vf=lueurs-feeriques)_.|
...
|16-20|Vous lancez le sort _[bourrasque](https://www.aidedd.org/dnd/sorts.php?vf=bourrasque)_.|
|21-25|Vous lancez le sort _[détection des pensées](https://www.aidedd.org/dnd/sorts.php?vf=detection-des-pensees)_ sur la cible que vous avez choisie. Si vous n'avez pas ciblé de créature, vous subissez à la place 1d6 dégâts psychiques.|
|26-30|Vous lancez le sort _[nuage nauséabond](https://www.aidedd.org/dnd/sorts.php?vf=nuage-nauseabond)_.|
...
|37-46|Vous lancez le sort _[éclair](https://www.aidedd.org/dnd/sorts.php?vf=eclair)_.|
...
|50-53|Vous augmentez la taille de la cible de la même manière que si vous aviez lancé le sort _[agrandissement/rapetissement](https://www.aidedd.org/dnd/sorts.php?vf=agrandissement-rapetissement)_. Si la cible ne peut pas être affectée par ce sort, ou si vous n'avez pas ciblé de créature, vous devenez la cible de ce sort.|
|54-58|Vous lancez le sort _[ténèbres](https://www.aidedd.org/dnd/sorts.php?vf=tenebres)_.|
...
|66-69|Vous êtes rétréci comme si vous aviez lancé sur vous le sort _[agrandissement/rapetissement](https://www.aidedd.org/dnd/sorts.php?vf=agrandissement-rapetissement)_.|
|70-79|Vous lancez le sort _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_.|
|80-84|Vous lancez le sort _[invisibilité](https://www.aidedd.org/dnd/sorts.php?vf=invisibilite)_ sur vous-même.|
...
Tant que vous tenez ce bâton, vous pouvez utiliser une action pour dépenser l'une de ses 10 charges afin de lancer le sort _[charme-personne](https://www.aidedd.org/dnd/sorts.php?vf=charme-personne)_, _[injonction](https://www.aidedd.org/dnd/sorts.php?vf=injonction)_ ou _[compréhension des langues](https://www.aidedd.org/dnd/sorts.php?vf=comprehension-des-langues)_ en utilisant votre propre DD des sorts. Le bâton peut également être utilisé en tant qu'arme magique.  
Si vous tenez le bâton et échouez un jet de sauvegarde contre un sort d'enchantement dont vous êtes la cible unique, vous pouvez transformer votre échec au jet de sauvegarde en une réussite. Vous ne pouvez plus utiliser cette propriété du bâton avant la prochaine aube. Si vous réussissez un jet de sauvegarde contre un sort d'enchantement dont vous êtes la cible unique, avec ou sans l'intervention du bâton, vous pouvez utiliser votre réaction pour dépenser 1 charge du bâton et renvoyer le sort à son lanceur originel comme si vous veniez de lancer ce sort.  
...
Le bâton possède 10 charges. Tant que vous le tenez, vous pouvez utiliser une action pour en dépenser 1 ou plusieurs charges afin de lancer l'un des sorts suivants tout en utilisant votre propre DD des sorts : _[mains brûlantes](https://www.aidedd.org/dnd/sorts.php?vf=mains-brulantes)_ (1 de charge), _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (3 charges) ou _[mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu)_ (4 charges).  
...
Le bâton possède 10 charges. Tant que vous le tenez, vous pouvez utiliser une action pour en dépenser 1 ou plusieurs charges afin de lancer l'un des sorts suivants tout en utilisant votre propre DD des sorts : _[cône de froid](https://www.aidedd.org/dnd/sorts.php?vf=cone-de-froid)_ (5 charges), _[nappe de brouillard](https://www.aidedd.org/dnd/sorts.php?vf=nappe-de-brouillard)_ (1 charge), _[tempête de grêle](https://www.aidedd.org/dnd/sorts.php?vf=tempete-de-grele)_ (4 charges) ou _[mur de glace](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-glace)_ (4 charges).  
...
**Sorts**. Tant que vous tenez le bâton, vous pouvez l'utiliser, en prenant une action pour dépenser plusieurs de ses charges, afin de lancer l'un des sorts suivants tout en utilisant votre propre DD des sorts : _[insecte géant](https://www.aidedd.org/dnd/sorts.php?vf=insecte-geant)_ (4 charges) ou _[fléau d'insectes](https://www.aidedd.org/dnd/sorts.php?vf=fleau-d-insectes)_ (5 charges).  
...
Ce bâton possède 10 charges. Tant que vous le tenez, vous pouvez utiliser une action pour dépenser 1 ou plusieurs charges afin de lancer l'un des sorts suivants tout en utilisant votre propre DD des sorts et le modificateur de votre caractéristique d'incantation : _[soins](https://www.aidedd.org/dnd/sorts.php?vf=soins)_ (1 charge par niveau d'emplacement de sort, jusqu'au niveau 4 maximum), _[restauration partielle](https://www.aidedd.org/dnd/sorts.php?vf=restauration-partielle)_ (2 charges) ou _[soins de groupe](https://www.aidedd.org/dnd/sorts.php?vf=soins-de-groupe)_ (5 charges).  
...
**Sorts**. Tant que vous tenez ce bâton, vous pouvez utiliser une action pour dépenser 1 ou plus de ses charges afin de lancer l'un des sorts suivants depuis le bâton, vous utilisez votre propre DD au jet de sauvegarde des sorts et votre bonus d'attaque avec un sort : _[cône de froid](https://www.aidedd.org/dnd/sorts.php?vf=cone-de-froid)_ (5 charges), _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (emplacement de sort niveau 5, 5 charges), _[globe d'invulnérabilité](https://www.aidedd.org/dnd/sorts.php?vf=globe-d-invulnerabilite)_ (6 charges), _[immobilisation de monstre](https://www.aidedd.org/dnd/sorts.php?vf=immobilisation-de-monstre)_ (5 charges), _[lévitation](https://www.aidedd.org/dnd/sorts.php?vf=levitation)_ (2 charges), _[éclair](https://www.aidedd.org/dnd/sorts.php?vf=eclair)_ (emplacement de sort niveau 5, 5 charges), _[projectile magique](https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique)_ (1 charge), _[rayon affaiblissant](https://www.aidedd.org/dnd/sorts.php?vf=rayon-affaiblissant)_ (1 charge) ou _[mur de force](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-force)_ (5 charges).  
...
Ce bâton peut être manié comme un bâton magique qui octroie un bonus de +2 à l'attaque et aux dégâts. Il a également les propriétés supplémentaires suivantes. Quand une de ces propriétés est utilisée, elle ne peut être réutilisée avant la prochaine aube.  
...
**Sorts**. Vous pouvez utiliser une action pour dépenser une ou plusieurs des charges du bâton et jeter l'un des sorts suivants depuis celui-ci, en utilisant le DD de sauvegarde de vos sorts : _[amitié avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=amitie-avec-les-animaux)_ (1 charge), _[éveil](https://www.aidedd.org/dnd/sorts.php?vf=eveil)_ (5 charges), _[peau d'écorce](https://www.aidedd.org/dnd/sorts.php?vf=peau-d-ecorce)_ (2 charges), _[localisation d'animaux ou de plantes](https://www.aidedd.org/dnd/sorts.php?vf=localisation-d-animaux-ou-de-plantes)_ (2 charges), _[communication avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-animaux)_ (1 charge), _[communication avec les plantes](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-plantes)_ (3 charges) ou _[mur d'épines](https://www.aidedd.org/dnd/sorts.php?vf=mur-d-epines)_ (6 charges).  
Vous pouvez également utiliser une action pour lancer le sort _[passage sans trace](https://www.aidedd.org/dnd/sorts.php?vf=passage-sans-trace)_ depuis le bâton sans utiliser aucune charge.  
**Forme d'arbre**. Vous pouvez utiliser une action pour planter une extrémité du bâton dans de la terre fertile et dépenser une charge pour le transformer en un arbre sain. L'arbre fait 18 mètres de haut, son tronc fait 1,50 mètre de diamètre et ses branches s'étalent au sommet sur un rayon de 7,50 mètres. L'arbre apparaît ordinaire mais dégage une faible aura de magie de transmutation s'il est ciblé par _[détection de la magie](https://www.aidedd.org/dnd/sorts.php?vf=detection-de-la-magie)_. Tout en touchant l'arbre et en utilisant une autre action pour prononcer le mot de commande, vous pouvez faire reprendre au bâton sa forme normale. Toute créature dans l'arbre tombe alors.  
...
**Sorts**. Tant que vous tenez ce bâton, vous pouvez utiliser une action pour dépenser plusieurs de ses charges afin de lancer l'un des sorts suivants depuis le bâton, vous utilisez votre propre DD au jet de sauvegarde des sorts et votre caractéristique d'incantation : _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_ (7 charges), _[dissipation de la magie](https://www.aidedd.org/dnd/sorts.php?vf=dissipation-de-la-magie)_ (3 charges), _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (emplacement de sort niveau 7, 7 charges), _[sphère de feu](https://www.aidedd.org/dnd/sorts.php?vf=sphere-de-feu)_ (2 charges), _[tempête de grêle](https://www.aidedd.org/dnd/sorts.php?vf=tempete-de-grele)_ (4 charges), _[invisibilité](https://www.aidedd.org/dnd/sorts.php?vf=invisibilite)_ (2 charges), _[déblocage](https://www.aidedd.org/dnd/sorts.php?vf=deblocage)_ (2 charges), _[éclair](https://www.aidedd.org/dnd/sorts.php?vf=eclair)_ (emplacement de sort niveau 7, 7 charges), _[passe-muraille](https://www.aidedd.org/dnd/sorts.php?vf=passe-muraille)_ (5 charges), _[changement de plan](https://www.aidedd.org/dnd/sorts.php?vf=changement-de-plan)_ (7 charges), _[télékinésie](https://www.aidedd.org/dnd/sorts.php?vf=telekinesie)_ (5 charges), _[mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu)_ (4 charges), ou _[toile d'araignée](https://www.aidedd.org/dnd/sorts.php?vf=toile-d-araignee)_ (2 charges).  
Vous pouvez également utiliser une action pour lancer l'un des sorts suivants grâce au bâton sans utiliser de charge : _[verrou magique](https://www.aidedd.org/dnd/sorts.php?vf=verrou-magique), [détection de la magie](https://www.aidedd.org/dnd/sorts.php?vf=detection-de-la-magie), [agrandissement/rapetissement](https://www.aidedd.org/dnd/sorts.php?vf=agrandissement-rapetissement), [lumière](https://www.aidedd.org/dnd/sorts.php?vf=lumiere), [main de mage](https://www.aidedd.org/dnd/sorts.php?vf=main-de-mage)_ ou _[protection contre le mal et le bien](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-le-Mal-et-le-Bien)_.  
**Frappe vengeresse**. Vous pouvez utiliser une action pour briser le bâton contre votre genou ou contre une surface solide, déclenchant alors la frappe vengeresse. Le bâton est détruit et libère la magie qui lui reste en une formidable explosion qui recouvre une zone sphérique de 9 mètres de rayons centrée sur lui.  
Vous avez 50 % de chance de voyager instantanément vers un plan d'existence aléatoire, échappant alors à l'explosion. Si vous ne parvenez pas à éviter l'effet, vous subissez un montant de dégâts de force égal à 16 x le nombre de charges dans le bâton. Toutes les autres créatures dans la zone doivent effectuer un jet de sauvegarde de Dextérité DD 17. En cas d'échec au jet de sauvegarde, une créature subit un montant de dégâts basé sur la distance entre elle et l'épicentre de l'explosion, comme indiqué sur la table ci-dessous. En cas de jet de sauvegarde réussi, une créature ne subit que la moitié des dégâts prévus.  
...
Lorsque vous portez ces bottes, vous pouvez utiliser une action pour lancer le sort _[lévitation](https://www.aidedd.org/dnd/sorts.php?vf=levitation)_ sur vous-même à volonté.  
...
La _boule de cristal_ typique, un objet très rare, a un diamètre de 15 cm. Tant que vous la touchez, vous pouvez lancer un sort _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_ (sauvegarde DD 17) grâce à elle.  
...
**Boule de cristal de lecture des pensées**. Vous pouvez utiliser votre action pour lancer le sort _[détection des pensées](https://www.aidedd.org/dnd/sorts.php?vf=detection-des-pensees)_ (sauvegarde DD 17) tant que vous êtes en pleine scrutation avec la _boule de cristal_, vous ciblez alors une créature que vous pouvez voir et située à 9 mètres maximum du capteur créé par le sort. Vous n'avez pas besoin de vous concentrer sur ce sort de _détection des pensées_ pour le maintenir pendant toute sa durée, mais il prend fin si le sort _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_ se termine.  
**Boule de cristal de télépathie**. Tant que vous êtes en pleine scrutation avec cette _boule de cristal_, vous pouvez communiquer par télépathie avec toutes les créatures que vous pouvez voir et qui se trouvent à 9 mètres maximum du capteur créé par le sort _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_. Vous pouvez également utiliser une action pour lancer le sort _[suggestion](https://www.aidedd.org/dnd/sorts.php?vf=suggestion)_ (sauvegarde DD 17) au travers du capteur sur l'une de ces créatures. Vous n'avez pas besoin de vous concentrer sur ce sort de _suggestion_ pour le maintenir pendant toute sa durée, mais il prend fin si le sort _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_ se termine. Une fois qu'il est utilisé, le pouvoir de _[suggestion](https://www.aidedd.org/dnd/sorts.php?vf=suggestion)_ de la _boule de cristal_ ne peut être réutilisé avant la prochaine aube.  
**Boule de cristal de vision véritable**. Tant que vous êtes en pleine scrutation avec cette _boule de cristal_, vous possédez la vision véritable dans un rayon de 36 mètres centré sur le capteur du sort _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_.  
...
|91-00|L'éfrit peut lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ trois fois pour vous. Il disparaît lorsqu'il a accordé le troisième souhait ou au bout d'une heure, puis la bouteille perd sa magie.|
...
Tant qu'un feu brûle dans ce brasero en cuivre, vous pouvez utiliser une action pour prononcer son mot de commande et convoquer un élémentaire du feu, comme si vous aviez lancé le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_. Le brasero ne peut plus être utilisé de cette façon avant la prochaine aube. Le brasero pèse 2,5 kg.  

# Broche de défense

Objet merveilleux, peu commun (nécessite un lien)

Tant que vous portez cette broche, vous obtenez la résistance aux dégâts de force, et êtes immunisé aux dégâts du sort _[projectile magique](https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique)_.  
...
• Vous pouvez utiliser votre action pour lancer le sort _[toile d'araignée](https://www.aidedd.org/dnd/sorts.php?vf=toile-d-araignee)_ (sauvegarde DD 13). Cette toile créée recouvre une surface deux fois plus grande que ce qui est indiqué dans la description du sort. Une fois qu'elle a été utilisée, cette propriété de la cape ne peut être réutilisée avant la prochaine aube.  
...
Tant que vous êtes équipé de cette cape et que vous vous trouvez dans une zone de lumière faible ou de ténèbres, vous pouvez utiliser votre action pour lancer sur vous-même le sort _[métamorphose](https://www.aidedd.org/dnd/sorts.php?vf=metamorphose)_ afin de vous transformer en chauve-souris. Tant que vous êtes sous la forme d'une chauve-souris, vous conservez vos valeurs d'Intelligence, de Sagesse, et de Charisme. La cape ne peut être réutilisée de cette manière avant la prochaine aube.  
...
Lorsque vous portez cette cape, vous pouvez utiliser une action pour prononcer son mot de commande. Cela transforme la cape en une paire d'ailes de chauve-souris ou d'oiseau sur votre dos pendant 1 heure, ou jusqu'à ce que vous répétiez le mot de commande au prix d'une action. Les ailes vous donnent une vitesse de vol de 18 mètres. Quand elles disparaissent, vous ne pouvez plus les réutiliser durant 1d12 heures.  

# Cape du prestidigitateur

Objet merveilleux, rare

Cette cape sent légèrement le soufre. Tant que vous en êtes équipé, vous pouvez vous en servir, en utilisant votre action, pour lancer le sort _[porte dimensionnelle](https://www.aidedd.org/dnd/sorts.php?vf=porte-dimensionnelle)_. Cette propriété de la cape ne peut être réutilisée avant la prochaine aube.  
Lorsque vous disparaissez, vous laissez derrière vous un nuage de fumée, et, à votre arrivée à destination, vous apparaissez également dans un nuage de fumée. La fumée obscurcit légèrement l'endroit que vous quittez et celui où vous apparaissez, et se dissipe à la fin de votre tour suivant. Un vent léger ou plus puissant disperse la fumée.  
...
**La Lune**. Vous obtenez la capacité de lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ 1d3 fois.  
**Le Néant**. Cette carte noire présage bien des désastres. Votre âme est extirpée de votre corps et retenue prisonnière dans un objet localisé dans un lieu du choix du MD. Un ou plusieurs êtres très puissants gardent l'endroit. Tant que votre âme est piégée de la sorte, votre corps est incapable d'agir. Un sort de _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ ne peut pas vous rendre votre âme, mais le sort révèle le lieu où l'objet est conservé. Vous ne tirez plus d'autres cartes.  
...
**Le Traître**. Un Personnage-Non-Joueur du choix du MD devient hostile envers vous. L'identité de votre nouvel ennemi reste inconnue jusqu'à ce que le PNJ ou quelqu'un d'autre la révèle. Seul un sort de _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ ou une intervention divine peut mettre un terme à l'hostilité du PNJ à votre encontre.  
...
Tant que vous êtes équipé de ce chapeau, vous pouvez à volonté, par une action, l'utiliser pour lancer le sort _[déguisement](https://www.aidedd.org/dnd/sorts.php?vf=deguisement)_. Le sort prend fin si le couvre-chef est retiré.  

# Chapeau de magicien

Objet merveilleux, commun (nécessite un lien avec un magicien)

Ce chapeau désuet en forme de cône est orné de croissants de lune et d'étoiles dorés. Tant que vous le portez, vous bénéficiez des avantages suivants :  

- Vous pouvez utiliser le chapeau comme focaliseur d'incantation pour vos sorts de magicien.
- Vous pouvez essayer de lancer un sort mineur que vous ne connaissez pas. Celui-ci doit figurer sur la liste des sorts de magicien et vous devez effectuer un jet d'Intelligence (Arcanes) DD 10. En cas de réussite, vous lancez le sort. En cas d'échec, le sort échoue également et l'action utilisée pour lancer le sort est perdue. Dans les deux cas, vous ne pourrez plus utiliser cette propriété avant d'avoir terminé un repos long.
...
Cette mince chandelle est dédiée à une divinité et partage l'alignement de cette divinité. L'alignement du cierge peut être détecté avec un sort de _[détection du mal et du bien](https://www.aidedd.org/dnd/sorts.php?vf=detection-du-mal-et-du-bien)_. Le MD choisit le dieu et l'alignement qui lui est associé ou détermine l'alignement du cierge de manière aléatoire.  
...
Sinon, lorsque vous allumez le cierge pour la première fois, vous pouvez lancer le sort _[portail](https://www.aidedd.org/dnd/sorts.php?vf=portail)_ grâce à lui. Le cierge est cependant détruit lorsqu'il est utilisé de la sorte.  
...
Une dose de glu peut recouvrir une surface carrée de 30 cm de côté. La glu sèche en 1 minute après application. Dès lors, le lien qu'elle crée ne peut être rompu que par l'application d'un _solvant universel_ ou d'une _huile éthérée_ ou grâce au sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_.  

# Collier d'adaptation

Objet merveilleux, peu commun (nécessite un lien)

Lorsque vous portez ce collier, vous pouvez respirer normalement dans tout environnement, et vous avez un avantage aux jets de sauvegarde contre les vapeurs et gaz nocifs (comme les effets de _[brume mortelle](https://www.aidedd.org/dnd/sorts.php?vf=brume-mortelle)_ et de _[nuage nauséabond](https://www.aidedd.org/dnd/sorts.php?vf=nuage-nauseabond)_, les poisons inhalés et les armes de souffle de certains dragons).  

# Collier de boules de feu

Objet merveilleux, rare

Ce collier possède 1d6 + 3 perles. Vous pouvez utiliser une action pour détacher une perle et la jeter jusqu'à 18 mètres de distance. Quand elle atteint la fin de sa trajectoire, la perle explose comme une _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ de niveau 3 (sauvegarde DD 15).  
Vous pouvez lancer plusieurs perles, ou même l'ensemble du collier, par une action. Lorsque vous procédez ainsi, augmentez le niveau de la _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ de 1 pour chaque perle au-delà de la première.  
...
Six types de perles magiques existent. Le MD décide le type de chaque perle du collier ou le détermine de façon aléatoire. Un collier peut avoir plus d'une perle de même type. Pour en utiliser une, vous devez porter le collier. Chaque perle contient un sort que vous pouvez lancer à partir d'elle par une action bonus (en utilisant le DD de sauvegarde de vos sorts si une sauvegarde est nécessaire). Une fois que le sort d'une perle magique est lancé, cette perle ne peut être réutilisée avant la prochaine aube.  

|d20|Perle de ...|Sort|
|---|---|---|
|1–6|Bénédiction|_[bénédiction](https://www.aidedd.org/dnd/sorts.php?vf=benediction)_|
|7–12|Soins|_[soins](https://www.aidedd.org/dnd/sorts.php?vf=soins)_ (niveau 2) ou _[restauration partielle](https://www.aidedd.org/dnd/sorts.php?vf=restauration-partielle)_|
|13-16|Faveur|_[restauration supérieure](https://www.aidedd.org/dnd/sorts.php?vf=restauration-superieure)_|
|17-18|Châtiment|_[châtiment révélateur](https://www.aidedd.org/dnd/sorts.php?vf=chatiment-revelateur)_|
|19|Invocation|_[allié planaire](https://www.aidedd.org/dnd/sorts.php?vf=allie-planaire)_|
|20|Vent|_[marche sur le vent](https://www.aidedd.org/dnd/sorts.php?vf=marche-sur-le-vent)_|
...
Vous pouvez utiliser une action pour souffler dans ce cor. En réponse, des esprits guerriers venant du Valhalla apparaissent dans un rayon de 18 mètres autour de vous. Ils utilisent les statistiques du [berserker](https://www.aidedd.org/dnd/monstres.php?vf=berserker). Ils retournent au Valhalla au bout d'une heure ou lorsqu'ils tombent à 0 point de vie. Une fois que vous avez utilisé le cor, il ne peut pas être réutilisé avant que 7 jours ne se soient écoulés.  
...
|d100|Type du cor|Berserkers  <br>invoqués|Condition|
|---|---|---|---|
...
Cette corne possède 4 charges. Lorsque vous utilisez une action pour souffler dans la corne, une créature de votre choix peut l'entendre retentir, à condition qu'elle se trouve dans un rayon de 180 mètres autour de la corne et qu'elle ne soit pas assourdie. Aucune autre créature n'entend le son provenant de la corne. Le cor récupère 1d4 charges dépensées chaque jour à l'aube.  

# Cornet acoustique

Objet merveilleux, commun

Si vous le portez à votre oreille, ce cornet supprime les effets de l'état assourdi sur vous-même, vous permettant d'entendre normalement.  
...
|---|---|
|_[Désintégration](https://www.aidedd.org/dnd/sorts.php?vf=desintegration)_|1d12|
|_Cor de dévastation_|1d10|
|_[Passe-muraille](https://www.aidedd.org/dnd/sorts.php?vf=passe-muraille)_|1d6|
|_[Rayons prismatiques](https://www.aidedd.org/dnd/sorts.php?vf=rayons-prismatiques)_|1d20|
|_[Mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu)_|1d4|
...
Vous pouvez utiliser une action pour appuyer sur une face du cube et ainsi lancer le sort _[portail](https://www.aidedd.org/dnd/sorts.php?vf=portail)_. Un portail s'ouvre alors vers le plan d'existence auquel est reliée la face du cube que vous avez pressée. Sinon, si vous utilisez une action pour appuyer deux fois sur la même face, vous pouvez lancer le sort _[changement de plan](https://www.aidedd.org/dnd/sorts.php?vf=changement-de-plan)_ (sauvegarde DD 17) avec le cube et transporter les cibles dans le plan d'existence relié à la face concernée.  
...
**Conscience surnaturelle**. Tant que vous tenez cette arme, elle vous alerte de la présence et de la position de toute porte secrète ou dissimulée dans un rayon de 9 mètres autour de vous. De plus, vous pouvez utiliser une action pour lancer _[détection du mal et du bien](https://www.aidedd.org/dnd/sorts.php?vf=detection-du-mal-et-du-bien)_ ou _[localisation d'objet](https://www.aidedd.org/dnd/sorts.php?vf=localisation-d-objet)_ depuis l'arme. Une fois que vous avez lancé l'un des sorts, vous ne pouvez plus le lancer avant la prochaine aube.  
...
Tant que vous êtes équipé de ce diadème, vous pouvez l'utiliser en prenant une action pour lancer le sort _[rayon ardent](https://www.aidedd.org/dnd/sorts.php?vf=rayon-ardent)_. Lorsque vous effectuez le jet d'attaque avec un sort, vous le faite en utilisant un bonus de +5 à l'attaque. Le diadème ne peut être réutilisé de la sorte avant la prochaine aube.  
...
Tant que de l'encens brûle dans cet encensoir, vous pouvez utiliser une action pour prononcer le mot de commande de l'encensoir et invoquer un élémentaire de l'air, comme si vous aviez lancé le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_. L'encensoir ne peut être réutilisé de la sorte avant la prochaine aube.  
...
Si l'épée n'est pas plongée dans le sang dans la minute qui suit sa sortie de fourreau, son porteur doit effectuer un jet de sauvegarde de Charisme DD 15. En cas d'échec au jet, le porteur est dominé par l'épée, comme s'il était sujet au sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_, et l'épée lui ordonne de lui faire prendre un bain de sang. L'effet du sort prend fin lorsque la requête de l'épée est satisfaite.  
**Propriétés aléatoires**. L'_Épée de Kas_ possède un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/):  
...
**Sorts**. Tant que l'épée est sur votre personne, vous pouvez utiliser une action pour lancer l'un des sorts suivants (sauvegarde DD 18) : _[appel de la foudre](https://www.aidedd.org/dnd/sorts.php?vf=appel-de-la-foudre), parole divine_ ou _[doigt de mort](https://www.aidedd.org/dnd/sorts.php?vf=doigt-de-mort)_. Une fois que vous avez utilisé l'épée pour lancer un sort, vous ne pouvez pas lancer le même sort avant la prochaine aube.  
...
**Détruire l'épée**. Une créature liée à la fois à l'_Œil de Vecna_ et à la _Main de Vecna_ peut utiliser la propriété Souhait de ces artéfacts combinés pour déconstruire l'_Épée de Kas_. La créature doit lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ et effectuer un jet de Charisme contre un jet de Charisme de l'épée. L'épée doit se trouver dans un rayon de 9 mètres de la créature, sans quoi le sort échoue. Si l'épée remporte l'opposition, rien ne se passe, et le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_ est dépensé pour rien. Si l'épée perd l'opposition, elle est détruite.  

# Épée de lumière lunaire

Arme (toute épée), commun

Dans les ténèbres, la lame dégainée de cette épée diffuse une lumière de clair de lune, créant une lumière vive dans un rayon de 4,50 mètres et une lumière faible sur 4,50 mètres supplémentaires.  
...
Vous pouvez briser la malédiction par les moyens traditionnels. Vous pouvez sinon lancer le sort _[bannissement](https://www.aidedd.org/dnd/sorts.php?vf=bannissement)_ sur l'épée pour forcer l'esprit vengeur à la quitter. L'épée devient alors une épée +1 sans aucune autre propriété.  
...
La créature existe pour une durée spécifique à chaque statuette. À la fin de cette durée, la créature reprend la forme de la statuette. Elle reprend la forme de la figurine plus tôt si elle tombe à 0 pv ou si vous utilisez une action pour prononcer le mot de commande tout en la touchant. Quand la créature redevient une statuette, ses propriétés ne peuvent être réutilisées avant un certain temps, spécifié dans la description de la statuette :  
**Griffon de bronze (Rare)**. Cette statuette de bronze représente un griffon rampant. Elle peut devenir un griffon pour une durée maximale de 6 heures. Une fois utilisée, elle ne peut être réutilisée avant 5 jours.  
**Mouche d'ébène (Rare)**. Cette statuette d'ébène est sculptée en forme de taon. Elle devient une mouche géante, qui peut être utilisée comme monture, pour une durée maximale de 12 heures. Une fois utilisée, elle ne peut être réutilisée avant 2 jours.  
**Lions d'or (Rare)**. Ces statuettes de lions en or sont toujours créées en paires. Vous pouvez utiliser une statuette ou les deux en même temps. Chacune peut devenir un lion pendant un maximum d'une heure. Une fois utilisé, un lion ne peut être réutilisé avant 7 jours.  
...
**Corbeau d'argent (Peu commun)**. Cette statuette de corbeau en argent peut devenir un corbeau pour une durée maximale de 12 heures. Une fois utilisée, elle ne peut plus l'être avant 2 jours. Dans sa forme animale, la statuette vous permet de lancer sur elle le sort _[messager animal](https://www.aidedd.org/dnd/sorts.php?vf=messager-animal)_ à volonté.  
...
Un sort d'_[identification](https://www.aidedd.org/dnd/sorts.php?vf=identification)_ révèle si une créature se trouve dans la flasque, mais le seul moyen de déterminer le type de la créature est d'ouvrir la flasque. Une urne nouvellement découverte pourrait déjà contenir une créature choisie par le MD ou déterminée aléatoirement.  
...
Cette gemme contient un brin d'énergie élémentaire. Lorsque vous utilisez une action pour briser la gemme, un élémentaire est invoqué comme si vous aviez jeté le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_, et la magie de la gemme est perdue. Le type de gemme détermine l'élémentaire invoqué par le sort.  
...
Cette petite sphère de verre épais pèse 500 g. Si vous êtes dans un rayon de 18 mètres autour d'elle, vous pouvez prononcer son mot de commande qui lui fait émaner un sort de _[lumière](https://www.aidedd.org/dnd/sorts.php?vf=lumiere)_ ou de _[lumière du jour](https://www.aidedd.org/dnd/sorts.php?vf=lumiere-du-jour)_. Une fois utilisé, l'effet de _[lumière du jour](https://www.aidedd.org/dnd/sorts.php?vf=lumiere-du-jour)_ ne peut être réutilisé avant l'aube suivante.  
...
**Propriétés aléatoires**. La hache possède un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
• 2 propriétés bénéfiques mineures  
• 1 propriété bénéfique majeure  
• 2 propriétés néfastes mineures  
...
**Invocation d'élémentaires de la terre**. Si vous tenez la hache, vous pouvez utiliser votre action pour lancer grâce à elle le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_, et ainsi invoquer un élémentaire de la terre. Vous ne pouvez pas réutiliser cette propriété avant la prochaine aube.  
**Voyage dans les profondeurs**. Vous pouvez utiliser une action pour toucher avec l'artéfact un morceau de maçonnerie naine autour de vous (ce doit être un élément du décor) et lancer le sort _[téléportation](https://www.aidedd.org/dnd/sorts.php?vf=teleportation)_ grâce à la hache. Si la destination que vous espérez atteindre se trouve sous la surface de la terre, vous êtes certain d'arriver là où vous le souhaitez. Vous ne pouvez pas réutiliser cette propriété avant que 3 jours ne se soient écoulés.  
**Malédiction**. La hache abrite une malédiction qui s'abat sur tout personnage non-nain qui se lie à elle. Même si le lien se termine, la malédiction reste présente. Chaque jour qui passe, l'apparence physique de la créature tend à ressembler de plus en plus à celle d'un nain. Au bout de sept jours, la créature ressemble à un nain typique, mais elle ne perd pas ses traits raciaux ni ne gagne ceux des nains. Les transformations physiques dues à la hache ne sont pas considérées comme magiques (et ne peuvent donc pas être dissipées), mais elles peuvent être annulées par n'importe quel effet levant les malédictions, comme les sorts _[restauration supérieure](https://www.aidedd.org/dnd/sorts.php?vf=restauration-superieure)_ et _[délivrance des malédictions](https://www.aidedd.org/dnd/sorts.php?vf=delivrance-des-maledictions)_.  
...
Tant que vous portez cette armure, vous pouvez prononcer son mot de commande par une action pour gagner l'effet du sort _[forme éthérée](https://www.aidedd.org/dnd/sorts.php?vf=forme-etheree)_ pendant 10 minutes ou jusqu'à ce que vous retiriez l'armure ou y mettiez fin volontairement en répétant le mot de commande. Cette propriété de l'armure ne peut être réutilisée avant la prochaine aube.  
...
• Vous pouvez utiliser une action pour lancer l'un des sorts suivants (sauvegarde DD 18), en utilisant l'une des gemmes du heaume d'un type donné comme composante : _[lumière du jour](https://www.aidedd.org/dnd/sorts.php?vf=lumiere-du-jour)_ (opale), _[boule de feu](https://www.aidedd.org/dnd/sorts.php?vf=boule-de-feu)_ (opale de feu), _[rayons prismatiques](https://www.aidedd.org/dnd/sorts.php?vf=rayons-prismatiques)_ (diamant) ou _[mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu)_ (rubis). La gemme est détruite lorsque le sort est lancé et disparaît du casque.  
...
Cet onguent noir collant est épais et pèse lourd dans le contenant, mais coule rapidement quand on le verse. L'huile peut couvrir une créature de taille M ou inférieure, ainsi que tout l'équipement qu'elle porte (un flacon supplémentaire est nécessaire pour chaque catégorie de taille au-dessus de M). L'application de l'huile prend 10 minutes. La créature affectée gagne alors l'effet du sort _[liberté de mouvement](https://www.aidedd.org/dnd/sorts.php?vf=liberte-de-mouvement)_ pendant 8 heures.  
L'huile peut aussi être versée au sol au prix d'une action, et couvre un carré de 3 mètres de côté, dupliquant l'effet du sort _[graisse](https://www.aidedd.org/dnd/sorts.php?vf=graisse)_ dans cette zone pendant 8 heures.  

# Huile éthérée

Potion, rare

Des perles de cette huile grise se forment à l'extérieur de son contenant et semblent s'évaporer rapidement. L'huile peut recouvrir une créature de taille M ou plus petite, ainsi que tout l'équipement qu'elle porte ou transporte (une fiole supplémentaire est nécessaire pour chaque catégorie de taille au-delà de M). Appliquer l'huile prend 10 minutes. La créature affectée gagne alors les effets du sort _[forme éthérée](https://www.aidedd.org/dnd/sorts.php?vf=forme-etheree)_ pendant 1 heure.  
...
|---|---|---|
|Tous|-|_[Vol](https://www.aidedd.org/dnd/sorts.php?vf=vol), [invisibilité](https://www.aidedd.org/dnd/sorts.php?vf=invisibilite), [lévitation](https://www.aidedd.org/dnd/sorts.php?vf=levitation), [protection contre le mal et le bien](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-le-mal-et-le-bien)_, plus les sorts listés ci-dessous en fonction de l'instrument|
|Bandore de Fochluchan|Peu commun|_[Enchevêtrement](https://www.aidedd.org/dnd/sorts.php?vf=enchevetrement), [lueurs féeriques](https://www.aidedd.org/dnd/sorts.php?vf=lueurs-feeriques), [gourdin magique](https://www.aidedd.org/dnd/sorts.php?vf=gourdin-magique), [communication avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=communication-avec-les-animaux)_|
|Cistre de Mac-Fuirmidh|Peu commun|_[Peau d'écorce](https://www.aidedd.org/dnd/sorts.php?vf=peau-d-ecorce), [soins](https://www.aidedd.org/dnd/sorts.php?vf=soins), [nappe de brouillard](https://www.aidedd.org/dnd/sorts.php?vf=nappe-de-brouillard)_|
|Harpe d'Anstruth|Très rare|_[Contrôle du climat](https://www.aidedd.org/dnd/sorts.php?vf=controle-du-climat), [soins](https://www.aidedd.org/dnd/sorts.php?vf=soins)_ (emplacement niveau 5), _[mur d'épines](https://www.aidedd.org/dnd/sorts.php?vf=mur-d-epines)_|
|Harpe d'Ollamh|Légendaire|_[Confusion](https://www.aidedd.org/dnd/sorts.php?vf=confusion), [contrôle du climat](https://www.aidedd.org/dnd/sorts.php?vf=controle-du-climat), [tempête de feu](https://www.aidedd.org/dnd/sorts.php?vf=tempete-de-feu)_|
|Luth de Doss|Peu commun|_[Amitié avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=amitie-avec-les-animaux), [protection contre une énergie](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-une-energie)_ (feu uniquement), _[protection contre le poison](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-le-poison)_|
|Lyre de Cli|Rare|_[Façonnage de la pierre](https://www.aidedd.org/dnd/sorts.php?vf=faconnage-de-la-pierre), [mur de feu](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-feu), [mur de vent](https://www.aidedd.org/dnd/sorts.php?vf=mur-de-vent)_|
|Mandoline de Canaith|Rare|_[soins](https://www.aidedd.org/dnd/sorts.php?vf=soins)_ (emplacement niveau 3), _[dissipation de la magie](https://www.aidedd.org/dnd/sorts.php?vf=dissipation-de-la-magie), [protection contre une énergie](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-une-energie)_ (foudre uniquement)|
...
Une fois cette jatte remplie d'eau, vous pouvez utiliser une action pour prononcer son mot de commande et convoquer un élémentaire de l'eau comme si vous aviez lancé le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_. La jatte ne peut être réutilisée de cette façon avant la prochaine aube.  
...
**Chance**. Si vos portez l'épée sur vous, vous pouvez invoquer sa chance (aucune action n'est requise) pour relancer un jet d'attaque, de caractéristique ou de sauvegarde dont le résultat vous déplaît. Vous devez accepter le nouveau résultat. Cette propriété ne peut être réutilisée avant la prochaine aube.  
**Souhait**. L'épée possède 1d4 - 1 charges. Tant que vous la tenez en main, vous pouvez utiliser une action pour dépenser une charge et lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_. Cette propriété ne peut être réutilisée avant la prochaine aube. L'épée perd cette propriété si elle n'a plus de charges.  
...
|41-80|La _Lamelune_ gagne une [propriété mineure déterminée aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/).|
...
|97-98|La _Lamelune_ fonctionne comme un _[anneau de stockage de sort](https://www.aidedd.org/dnd/om.php?vf=anneau-de-stockage-de-sort)_.|
|99|Vous pouvez utiliser une action pour appeler une ombre elfique, à condition que vous n'en ayez pas déjà une à votre service. L'ombre elfique apparaît dans un espace inoccupé situé à 36 mètres de vous maximum. Elle utilise les mêmes statistiques qu'une **_https://www.aidedd.org/dnd/monstres.php?vf=ombreombre_** _à quelques différences près : son alignement est neutre, elle est immunisée aux effets de renvoi des morts-vivants, et ne peut pas créer d'autres ombres. Vous contrôlez cette créature, décidez de comment elle se déplace et agit. Elle reste présente jusqu'à ce que ses points de vie tombent à 0 ou que vous la renvoyiez en utilisant une action._|
...
**Propriétés aléatoires**. Le livre possède un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
...
**Ordre Infernal**. Tant que vous êtes lié au livre et que vous le tenez en main, vous pouvez utiliser une action pour lancer le sort _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ sur une cible mauvaise (sauvegarde DD 18). Vous ne pouvez pas réutiliser cette propriété avant la prochaine aube.  
...
**Propriétés aléatoires**. Les _Chapitres sacrés_ possèdent un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
• 2 propriétés bénéfiques mineures  
...
Le médaillon possède 3 charges. Lorsque vous le portez, vous pouvez utiliser une action et dépenser 1 charge pour lancer le sort _[détection des pensées](https://www.aidedd.org/dnd/sorts.php?vf=detection-des-pensees)_ (sauvegarde DD 13) depuis le médaillon. Le médaillon récupère 1d3 charges dépensées chaque jour à l'aube.  
...
_Noir rasoir_ peut lancer le sort _[hâte](https://www.aidedd.org/dnd/sorts.php?vf=hate)_ sur vous une fois par jour. C'est elle qui décide quand lancer ce sort et maintient la concentration, vous n'avez pas à le faire.  
...
**Propriétés aléatoires**. _L'Œil de Vecna_ et la _Main de Vecna_ possèdent chacun un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
• 1 propriété bénéfique mineure  
• 1 propriété bénéfique majeure  
• 1 propriété néfaste mineure  
...
• Vous pouvez utiliser une action pour voir comme si vous portiez un _[anneau de rayons X](https://www.aidedd.org/dnd/om.php?vf=anneau-de-rayons-x)_. Vous pouvez mettre un terme à cet effet en utilisant une action bonus.  
• L'œil possède 8 charges. Vous pouvez utiliser une action pour dépenser une ou plusieurs de ses charges afin de lancer l'un des sorts suivants (sauvegarde DD 18) : _[clairvoyance](https://www.aidedd.org/dnd/sorts.php?vf=clairvoyance)_ (2 charges), _[couronne du dément](https://www.aidedd.org/dnd/sorts.php?vf=couronne-du-dement)_ (1 charge), _[désintégration](https://www.aidedd.org/dnd/sorts.php?vf=desintegration)_ (4 charges), _[domination de monstre](https://www.aidedd.org/dnd/sorts.php?vf=domination-de-monstre)_ (5 charges) ou _[mauvais œil](https://www.aidedd.org/dnd/sorts.php?vf=mauvais-oeil)_ (4 charges). L'œil récupère 1d4 + 4 charges dépensées chaque jour à l'aube. Chaque fois que vous lancez un sort via l'œil, il y a 5 % de chance que Vecna arrache votre âme de votre corps, la dévore, puis prenne le contrôle de votre corps qui devient alors sa poupée. Lorsque cela arrive, vous devenez un PNJ sous le contrôle du MD.  
...
• La main possède 8 charges. Vous pouvez utiliser une action pour dépenser une ou plusieurs de ses charges afin de lancer l'un des sorts suivants (sauvegarde DD 18) : _[doigt de mort](https://www.aidedd.org/dnd/sorts.php?vf=doigt-de-mort)_ (5 charges), _[sommeil](https://www.aidedd.org/dnd/sorts.php?vf=sommeil)_ (1 charge), _[lenteur](https://www.aidedd.org/dnd/sorts.php?vf=lenteur)_ (2 charges) ou _[téléportation](https://www.aidedd.org/dnd/sorts.php?vf=teleportation)_ (3 charges). La main récupère 1d4 + 4 charges dépensées chaque jour à l'aube. Chaque fois que vous lancez un sort via la main, celle-ci lance le sort _[suggestion](https://www.aidedd.org/dnd/sorts.php?vf=suggestion)_ sur vous (sauvegarde DD 18) et vous demande de commettre un acte mauvais. La main pourrait avoir une idée précise de l'acte à commettre, ou pourrait vous laisser choisir.  
...
• Vous pouvez utiliser une action pour lancer le sort _[souhait](https://www.aidedd.org/dnd/sorts.php?vf=souhait)_. Cette propriété ne peut pas être réutilisée avant que 30 jours ne se soient écoulés.  
**Détruire l'Œil et la Main**. Si l'_Œil de Vecna_ ou la _Main de Vecna_ sont tous les deux attachés sur la même créature, et que la créature est frappée par l'_[Épée de Kas](https://www.aidedd.org/dnd/om.php?vf=epee-de-kas)_, l'œil et la main prennent feu tous les deux, sont réduits en cendre et détruits pour toujours. Toute autre tentative pour détruire l'œil ou la main semble initialement fonctionner, mais l'artéfact en question réapparaît toujours dans l'un des nombreux caveaux cachés de Vecna, et attend d'être de nouveau découvert.  
...
Tant que vous êtes charmé par l'orbe, vous ne pouvez pas volontairement mettre fin à votre lien, de plus l'orbe lance le sort _[suggestion](https://www.aidedd.org/dnd/sorts.php?vf=suggestion)_ sur vous à volonté (sauvegarde DD 18), vous exhortant à travailler d'arrache-pied à ses propres objectifs maléfiques. L'essence du dragon se trouvant dans l'orbe pourrait vouloir de nombreuses choses : le génocide d'un peuple particulier, être libéré de l'orbe, répandre la souffrance et la destruction sur le monde, développer le culte de Tiamat, ou quelque chose d'autre suivant la décision du MD.  
**Propriétés aléatoires**. Un _Orbe des dragons_ possède un certain nombre de [propriétés déterminées aléatoirement](https://www.aidedd.org/regles/objets-magiques/artefacts/) :  
• 2 propriétés mineures bénéfiques  
• 1 propriété mineure néfaste  
• 1 propriété majeure néfaste  
**Sorts**. L'orbe possède 7 charges et récupère 1d4 + 3 charges dépensées chaque jour à l'aube. Si vous contrôlez l'orbe, vous pouvez utiliser une action et dépenser 1 charge ou plus pour lancer l'un des sorts suivants (sauvegarde DD 18) grâce à lui : _[soins](https://www.aidedd.org/dnd/sorts.php?vf=soins)_ (emplacement de sort niveau 5, 3 charges), _[lumière du jour](https://www.aidedd.org/dnd/sorts.php?vf=lumiere-du-jour)_ (1 charge), _[protection contre la mort](https://www.aidedd.org/dnd/sorts.php?vf=protection-contre-la-mort)_ (2 charges) ou _[scrutation](https://www.aidedd.org/dnd/sorts.php?vf=scrutation)_ (3 charges).  
Vous pouvez également utiliser une action pour lancer le sort _[détection de la magie](https://www.aidedd.org/dnd/sorts.php?vf=detection-de-la-magie)_ depuis l'orbe sans utiliser de charge.  
**Appel des dragons**. Tant que vous contrôlez l'orbe, vous pouvez utiliser une action pour que l'orbe lance un appel télépathique dans toutes les directions à 60 kilomètres à la ronde. Les dragons mauvais à portée se sentent obligés de venir vers l'orbe aussi vite que possible et par le chemin le plus direct. Les divinités dragons, comme Tiamat, ne sont pas affectées par cet appel. Les dragons que vous avez contraints par l'orbe pourraient bien vous être hostiles à leur arrivée. Une fois que vous avez utilisé cette propriété, elle ne peut être réutilisée pendant 1 heure.  
**Détruire un orbe**. Un _Orbe des dragons_ semble fragile mais il est en réalité insensible à la plupart des dégâts, dont les attaques et souffles des dragons. Cependant, un sort de _[désintégration](https://www.aidedd.org/dnd/sorts.php?vf=desintegration)_ ou un bon coup infligé par une arme magique +3 sont suffisants pour détruire l'orbe.  
...
|Niveau  <br>du sort|Rareté|DD de  <br>sauvegarde|Bonus  <br>d'attaque|
|---|---|---|---|
...
Tant que cette perle est sur vous, vous pouvez utiliser une action pour prononcer son mot de commande et récupérer un emplacement de sort dépensé. Si l'emplacement de sort était de niveau 4 ou supérieur, le nouvel emplacement est de niveau 3. Une fois que vous avez utilisé la perle, elle ne peut être réutilisée avant la prochaine aube.  

# Perle désaltérante

Objet merveilleux, commun

Cette perle spongieuse, sans saveur et gélatineuse, se dissout dans un liquide, transformant jusqu'à l'équivalent d'une pinte en eau potable fraîche et froide. La perle n'a aucun effet sur les liquides magiques ou les substances nocives telles que le poison.  
...
Si la pierre est en contact avec le sol, vous pouvez utiliser une action pour prononcer son mot de commande et invoquer un élémentaire de la Terre, comme si vous aviez lancé le sort _[invocation d'élémentaire](https://www.aidedd.org/dnd/sorts.php?vf=invocation-d-elementaire)_. La pierre ne peut être réutilisée de cette façon avant la prochaine aube. La pierre pèse 2,5 kg.  
...
Les _pierres de communication à distance_ fonctionnent par paire, chacune de ces pierres lisses étant sculptée pour correspondre à sa pierre complémentaire.  
Tant que vous touchez une pierre, vous pouvez utiliser une action pour lancer le sort _[communication à distance](https://www.aidedd.org/dnd/sorts.php?vf=communication-a-distance)_ grâce à elle. La cible du sort est le porteur de l'autre pierre. Si aucune créature ne porte l'autre pierre, vous en êtes averti dès que vous utilisez votre pierre, et le sort n'est pas lancé.  
...
Si vous plantez un arbuste ordinaire dans ce pot en argile de 5 kg et le laissez pousser pendant 30 jours, l'arbuste se transforme magiquement en un [arbuste éveillé](https://www.aidedd.org/dnd/monstres.php?vf=arbuste-eveille) à la fin de cette période. Lorsque l'arbuste se réveille, ses racines brisent le pot et le détruisent. L'arbuste éveillé est amical envers vous. En l'absence d'ordres de votre part, il ne fait rien.  

# Potion d'agrandissement

Potion, peu commun

Lorsque vous buvez cette potion, vous bénéficiez de l'effet « agrandissement » du sort _[agrandissement/rapetissement](https://www.aidedd.org/dnd/sorts.php?vf=agrandissement-rapetissement)_ pendant 1d4 heures (aucune concentration n'est requise). Une couleur rouge s'étend depuis une petite perle pour colorer le liquide clair de la potion, puis se contracte. Secouer la fiole n'interrompt pas ce processus.  

# Potion d'amitié avec les animaux

Potion, peu commun

Quand vous buvez cette potion, vous pouvez lancer le sort _[amitié avec les animaux](https://www.aidedd.org/dnd/sorts.php?vf=amitie-avec-les-animaux)_ (sauvegarde DD 13) pendant 1 heure à volonté. Agiter ce liquide boueux fait apparaître de petits morceaux : une écaille de poisson, une langue de colibri, une griffe de chat ou un poil d'écureuil.  
...
Après avoir bu cette potion, vous gagnez 10 points de vie temporaires qui durent 1 heure. Durant tout ce temps, vous êtes sous l'effet du sort _[bénédiction](https://www.aidedd.org/dnd/sorts.php?vf=benediction)_ (pas de concentration requise). Cette potion présente des bulles bleues et des vapeurs comme si elle était bouillante.  
...
Quand vous buvez cette potion, vous bénéficiez de l'effet du sort _[clairvoyance](https://www.aidedd.org/dnd/sorts.php?vf=clairvoyance)_. Un globe oculaire s'agite sur le liquide jaunâtre, mais disparaît lorsque la potion est ouverte.  

# Potion de diminution

Potion, rare

Lorsque vous buvez cette potion, vous bénéficiez de l'effet « rapetissement » du sort _[agrandissement/rapetissement](https://www.aidedd.org/dnd/sorts.php?vf=agrandissement-rapetissement)_ pendant 1d4 heures (pas de concentration requise). Le rouge du liquide de cette potion se contracte en permanence en une petite perle, puis s'étend pour colorer le liquide clair autour de lui. Secouer la bouteille n'interrompt pas ce processus.  
...
Lorsque vous buvez cette potion, vous bénéficiez de l'effet du sort _[forme gazeuse](https://www.aidedd.org/dnd/sorts.php?vf=forme-gazeuse)_ pour 1 heure (pas de concentration requise) ou jusqu'à ce que vous mettiez fin à l'effet par une action bonus. Le flacon de cette potion semble contenir un brouillard qui se déplace et se déverse comme de l'eau.  
...
Quand vous buvez cette potion, vous bénéficiez de l'effet du sort _[détection des pensées](https://www.aidedd.org/dnd/sorts.php?vf=detection-des-pensees)_ (sauvegarde DD 13). Dans la potion, d'un liquide pourpre dense, flotte un nuage ovoïde rose.  

# Potion de poison

Potion, peu commun

Cette concoction ressemble, sent et a le gout d'une _potion de guérison_ ou de toute autre potion bénéfique. Cependant, c'est effectivement du poison masqué par une illusion magique. Un sort d'_[identification](https://www.aidedd.org/dnd/sorts.php?vf=identification)_ révèle sa vraie nature.  
...
Trouvée dans un petit contenant, cette poudre ressemble à du sable très fin. Il ressemble à de la poussière de disparition, et un sort d'_[identification](https://www.aidedd.org/dnd/sorts.php?vf=identification)_ l'indique comme tel. Il y a suffisamment de poudre pour une seule utilisation.  
Lorsque vous utilisez une action pour lancer une poignée de cette poudre dans les airs, vous, et toute créature ayant besoin de respirer et se trouvant à 9 mètres de vous, devez réussir un jet de sauvegarde de Constitution DD 15 sous peine d'être incapable de respirer à cause d'une quinte d'éternuements incontrôlables. Une créature affectée de cette manière est incapable d'agir et suffoque. Aussi longtemps qu'elle est consciente, une créature peut retenter ce jet de sauvegarde à la fin de chacun de ses tours, mettant un terme à l'effet qui l'affecte en cas de réussite. Le sort _[restauration partielle](https://www.aidedd.org/dnd/sorts.php?vf=restauration-partielle)_ peut également mettre un terme à cet effet sur une créature.  
...
Vous pouvez utiliser une action pour déplier le _puits portable_ et le placer sur ou contre une surface solide, ce qui créé alors un trou extra dimensionnel de 3 mètres de profondeur. Le trou cylindrique existe dans un plan différent ce qui fait qu'il ne peut pas être utilisé pour créer des passages ou passer à travers un mur. Toute créature à l'intérieur du _puits portable_ peut en sortir en escaladant les parois.  
Vous pouvez utiliser une action pour fermer le _puits portable_ en le repliant à partir des bords. Plier le tissus ferme le trou et toute créature ou objet qui s'y trouve reste dans l'espace extradimensionnel. Quoiqu'il s'y trouve, le _puits portable_ ne pèse rien.  
Si le trou est plié, une créature qui se trouverait à l'intérieur de l'espace extradimensionnel peut utiliser une action et faire un jet de Force DD 10. En cas de réussite, la créature force le passage et apparaît à 1,50 mètre du _puits portable_ où de la créature qui le porte sur elle. Une créature qui respire à l'intérieur du trou peut respirer pendant 10 minutes, après quoi elle commence à manquer d'air et à suffoquer.  
Placer un _puits portable_ dans un autre espace extradimensionnel comme un _sac sans fond_, un _havresac magique d'Hévard_ ou tout autre objet similaire détruit instantanément les deux objets et ouvre un portail sur le plan Astral. Le portail ouvre vers l'endroit où était placé l'objet à l'intérieur de l'autre. Toute créature située à 3 mètres ou moins de la porte y est aspirée et laissée à une position aléatoire du plan Astral. Le portail se referme alors immédiatement. C'est un portail à sens unique qui ne peut être ré-ouvert.  

# Regard charmeur

Objet merveilleux, peu commun (nécessite un lien)

Ces lentilles de cristal se placent sur les yeux. Elles possèdent 3 charges. Tant que vous en êtes équipé, vous pouvez dépenser 1 charge en utilisant une action et ainsi lancer le sort _[charme-personne](https://www.aidedd.org/dnd/sorts.php?vf=charme-personne)_ (sauvegarde DD 13) sur un humanoïde se trouvant à 9 mètres de vous, à condition que vous et la cible puissiez vous voir mutuellement. Les lentilles récupèrent toutes les charges dépensées chaque jour à l'aube.  

# Robe aux étoiles

Objet merveilleux, très rare (nécessite un lien)

Cette robe noire ou bleue foncée est brodée de petites étoiles blanches ou argentées. Vous gagnez un bonus de +1 aux jets de sauvegarde tant que vous êtes équipé de cette robe. Six étoiles, situées sur la robe au niveau du torse, sont particulièrement larges. Tant que vous êtes équipé de cette robe, vous pouvez utiliser une action pour prélever l'une de ces étoiles et l'utiliser pour lancer un sort de _[projectile magique](https://www.aidedd.org/dnd/sorts.php?vf=projectile-magique)_ (équivalent à un emplacement de sort de niveau 5). Chaque jour, au crépuscule, 1d6 étoiles prélevées réapparaissent sur la robe.  
...
Un sort de _[lumière](https://www.aidedd.org/dnd/sorts.php?vf=lumiere)_ lancé sur la robe ou de _[lumière du jour](https://www.aidedd.org/dnd/sorts.php?vf=lumiere-du-jour)_ lancé à 1,50 mètre de la robe vous aveugle pendant 1 minute. À la fin de chacun de vos tours, vous pouvez effectuer un jet de sauvegarde de Constitution (DD 11 pour le sort _lumière_ ou DD 15 pour le sort _lumière du jour_), mettant à terme à l'aveuglement en cas de réussite.  
...
Si on l'examine superficiellement, ce sac ressemble à un _[sac sans fond](https://www.aidedd.org/dnd/om.php?vf=sac-sans-fond)_, mais c'est en réalité un orifice par lequel s'alimente une gigantesque créature extradimensionnelle. Si on retourne le fond du sac, l'orifice se ferme.  
...
Si vous pressez le **bouton 1**, une lame enflammée jaillit de l'extrémité opposée à la lanière, le sceptre devient une _[épée ardente](https://www.aidedd.org/dnd/om.php?vf=epee-ardente)_ (vous choisissez le type d'épée).  
...
Le sceptre possède 5 charges. Tant que vous le tenez, vous pouvez utiliser une action pour lancer depuis le sceptre l'un des sorts suivants : _[guérison](https://www.aidedd.org/dnd/sorts.php?vf=guerison)_ (dépense 1 charge) ou _[résurrection](https://www.aidedd.org/dnd/sorts.php?vf=resurrection)_ (dépense 5 charges).  
...
**Sorts**. Tant que vous tenez le sceptre, vous pouvez l'utiliser, par une action, pour lancer l'un des sorts suivants : _[détection du mal et du bien](https://www.aidedd.org/dnd/sorts.php?vf=detection-du-mal-et-du-bien), [détection de la magie](https://www.aidedd.org/dnd/sorts.php?vf=detection-de-la-magie), [détection du poison et des maladies](https://www.aidedd.org/dnd/sorts.php?vf=detection-du-poison-et-des-maladies)_ ou _[voir l'invisible](https://www.aidedd.org/dnd/sorts.php?vf=voir-l-invisible)_.  
...
Tant que vous tenez ce sceptre, vous gagnez un bonus aux jets d'attaque avec un sort et au DD de sauvegarde pour résister à vos sorts d'occultiste. Le bonus est déterminé par la rareté du sceptre.  
...
Si la sphère entre en contact avec un portail planaire, comme celui créé par le sort _[portail](https://www.aidedd.org/dnd/sorts.php?vf=portail)_, ou un espace extradimensionnel, comme celui d'un _[puits portable](https://www.aidedd.org/dnd/om.php?vf=puits-portable)_, le MD détermine de manière aléatoire ce qui se produit, en utilisant la table suivante.  
...
Lorsque vous effectuez un jet d'Intelligence (Arcanes) pour contrôler une _[sphère d'annihilation](https://www.aidedd.org/dnd/om.php?vf=sphere-d-annihilation)_ alors que vous tenez ce talisman, vous doublez votre bonus de maîtrise pour le jet. En outre, lorsque vous démarrez votre tour en contrôlant une _sphère d'annihilation_, vous pouvez utiliser une action pour la faire léviter de 3 mètres plus un nombre de mètres supplémentaires égal à 3 x votre modificateur d'Intelligence.  
...
|d100|Dimension|Capacité|Vitesse  <br>de vol|
|---|---|---|---|
...
Si vous pouvez vous lier à cet objet, vous pouvez l'utiliser en tant que grimoire et en tant que focaliseur arcanique. De plus, tant que vous tenez cet objet, vous pouvez utiliser votre action bonus pour lancer un sort que vous avez écrit dans ce tome, sans dépenser un emplacement de sort ni utiliser de composante verbale ou somatique. Après avoir été utilisée, cette propriété du tome ne peut plus être réutilisée avant le prochain levé de soleil.  
