...
Le système de gestion des [[Partir à l'aventure#temps-morts|temps morts]] présenté ici est construit sur deux éléments de base. Tout d'abord, il présente le concept d'antagoniste. Ensuite, il détaille plusieurs activités de temps morts pour les personnages.
...
#### [[Temps morts (XGtE)\_1#acheter-om|Acheter un objet magique]]
...
#### [[Temps morts (XGtE)\_1#fete|Faire la fête]]
...
#### [[Temps morts (XGtE)\_1#fabriquer-om|Fabriquer un objet]]
...
Un personnage peut vendre l'objet créé au [[Équipement|prix de vente]] indiqué par les règles.

**Fabriquer un objet magique**. Créer un objet magique demande plus qu'un investissement en temps, en efforts et en matériaux. C'est un long processus qui demandera une ou plusieurs aventures afin de se procurer les matériaux rares et les connaissances nécessaires. Les [*potions de guérison*](dnd/om.php?vf=potion-de-guerison) et les [*parchemins de sort*](dnd/om.php?vf=parchemin-de-sort) sont des exceptions aux règles qui suivent. Pour les *potions de guérison*, reportez-vous au paragraphe "Potions de guérison" dans cette section. Pour les *parchemins de sort*, reportez-vous à la section [[Temps morts (XGtE)\_1#ecrire-om|Écrire un parchemin de sort]].
...
Choisissez un monstre ou un lieu qui sera en rapport avec l'objet magique. Idéalement, ils partageront un lien élément ou une même nature. Par exemple, l'*[armure de matelot](dnd/om.php?vf=armure-de-matelot)* pourrait demander l'essence d'une [sentinelle d'eau](dnd/monstres.php?vf=sentinelle-d-eau). Un *[bâton d’envoûtement](dnd/om.php?vf=baton-d-envoutement)* pourrait nécessiter la coopération d'un [arcanaloth](dnd/monstres.php?vf=arcanaloth) particulier, qui acceptera d'aider les personnages s'ils complètent une tâche pour lui au préalable. Créer un *[bâton de surpuissance](dnd/om.php?vf=baton-de-surpuissance)* pourrait nécessiter de trouver un bout d'une pierre ancienne qui aurait été touchée jadis par le dieu de la magie lui-même, pierre qui pourrait être gardée par un [androsphinx](dnd/monstres.php?vf=androsphinx) suspicieux.
...
**Potions de guérison**. Les [*potions de guérison*](dnd/om.php?vf=potion-de-guerison) suivent un procédé de fabrication spécial qui est différent des autres objets magiques. Tout personnage qui maîtrise le kit d'herboriste peut les créer. Les ressources et le temps nécessaire sont décrits dans la table suivante.
...
#### [[Temps morts (XGtE)\_1#crime|Perpétrer un crime]]
...
#### [[Temps morts (XGtE)\_1#jouer|Parier]]
...
#### [[Temps morts (XGtE)\_1#combats|Combat]]tre
...
#### [[Temps morts (XGtE)\_1#relaxation|Relaxation]]
...
#### [[Temps morts (XGtE)\_1#religieux|Service religieux]]
...
#### [[Temps morts (XGtE)\_1#recherches|Faire des recherches]]
...
#### [[Temps morts (XGtE)\_1#ecrire-om|Rédiger un parchemin de sort]]

![Parchemin magique](assets/intro/articles/UA/downtime3.jpg)Avec du temps et de la patience, un lanceur de sort peut coucher sur un parchemin ses connaissances, afin de créer un [*parchemins de sort*](dnd/om.php?vf=parchemin-de-sort).
...
#### [[Temps morts (XGtE)\_1#vendre-om|Vendre un objet magique]]
...
#### [[Temps morts (XGtE)\_1#formation|Se former]]
...
#### [[Temps morts (XGtE)\_1#travail|Travailler]]
