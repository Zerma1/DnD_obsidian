---
title: "Génasi"
source: "https://www.aidedd.org/regles/races/genasis/"
tags:
  - dnd5
  - regles
---
...
**Se mêler au vent**. Vous pouvez lancer le sort [*lévitation*](dnd/sorts.php?vf=levitation) une fois, sans composante matérielle, et vous regagnez la capacité de le relancer ainsi après un repos long. La Constitution est votre caractéristique d'incantation pour ce sort.
...
**Fusionner avec la pierre**. Vous pouvez lancer le sort [*passage sans trace*](dnd/sorts.php?vf=passage-sans-trace) une fois, sans composante matérielle, et vous regagnez la capacité de le relancer ainsi après un repos long. La Constitution est votre caractéristique d'incantation pour ce sort.
...
**Appeler la vague**. Vous pouvez lancer le sort mineur [*façonnage de l’eau*](dnd/sorts.php?vf=faconnage-de-l-eau). Une fois le niveau 3 atteint, vous pouvez lancer le sort [*création ou destruction d’eau*](dnd/sorts.php?vf=creation-ou-destruction-d-eau) une fois comme un sort de niveau 2 et vous regagnez la capacité de le relancer ainsi après un repos long. La Constitution est votre caractéristique d'incantation pour ce sort.
