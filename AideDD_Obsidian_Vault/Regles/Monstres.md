---
title: "Monstres"
source: "https://www.aidedd.org/regles/monstres/"
tags:
  - dnd5
  - regles
---
...
Les statistiques d'une [[Liste des Monstres|créature]], parfois appelées « bloc de stat », fournissent l'essentiel des informations nécessaires pour jouer le monstre.
...
Une créature avec une vitesse de vol peut utiliser une partie de son mouvement pour voler. Certaines créatures ont la capacité de vol **stationnaire**, ce qui les rend difficile à faire tomber (comme expliqué dans les règles de [[Combat#mouvement|vol]]). Toute créature qui meurt cesse instantanément de voler.

### Valeurs de caractéristique

Toutes les créatures ont six valeurs de caractéristiques (Force, Dextérité, Constitution, Intelligence, Sagesse et Charisme) et les modificateurs correspondants (voir [[Utiliser les caractéristiques|Caractéristiques]]pour plus d'information sur les caractéristiques).
...
| --- | --- | --- | --- |
|  |  |  |  |
| **Facteur de puissance** | **Bonus de maîtrise** | **Facteur de puissance** | **Bonus de maîtrise** |
| 0 | +2 | 14 | +5 |
| 1/8 | +2 | 15 | +5 |
| 1/4 | +2 | 16 | +5 |
| 1/2 | +2 | 17 | +6 |
...
![Tarasque](assets/regles/monstre.jpg "Tarasque")Le champ Compétences est réservé aux créatures qui ont la maîtrise d'une ou plusieurs compétences. Par exemple, une créature aux facultés de perception élevées et naturellement très discrète peut avoir un bonus de maîtrise à ses jets de Sagesse (Perception) et de Dextérité (Discrétion).
...
Une créature avec la capacité Incantation a un niveau de lanceur de sorts et des emplacements de sorts, lesquels sont utilisés pour incanter ses sorts de niveau 1 et plus (voir [[Incantations|Magie]]). Le niveau de lanceur de sorts est également utilisé pour tout sort mineur lancé par la créature.
...
### [[Monstres\_1#usage-limite|Usage limité]]
