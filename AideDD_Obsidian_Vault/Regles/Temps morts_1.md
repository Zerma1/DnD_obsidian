---
title: "Temps morts"
source: "https://www.aidedd.org/regles/temps-morts"
tags:
  - dnd5
  - regles
---
...
Le chapitre [[Partir à l'aventure#temps-morts|Partir à l'aventure]] du *Manuel des Joueurs* décrit quelques activités de temps morts pour combler le vide entre les aventures. Selon le style de votre campagne, les backgrounds et les intérêts particuliers des aventuriers, vous pouvez ajouter une partie ou la totalité des activités suivantes, en tant qu'option.

#### [[Temps morts\_1#construire-une-place-forte|Construire une place forte]]
...
#### [[Temps morts\_1#fete|Faire la fête]]
...
#### [[Temps morts\_1#fabriquer-om|Fabriquer un objet magique]]
...
Normalement, un personnage qui entreprend cette activité crée un [[Objets magiques|objet magique]] issu du DMG. Mais vous pouvez décider de permettre aux joueurs de concevoir leurs propres objets magiques, en utilisant les lignes directrices du chapitre Atelier du MD du DMG.
...
#### [[Temps morts\_1#renommee|Gagner de la renommée]]
...
#### [[Temps morts\_1#vendre-om|Vendre des objets magiques]]
...
#### [[Temps morts\_1#rumeurs|Propager des rumeurs]]
...
#### [[Temps morts\_1#entrainer|S’entraîner pour gagner des niveaux]]
...
Il n'est pas inhabituel pour des aventuriers, surtout après le niveau 10, de devenir propriétaire d'un château, d'une taverne ou d'une autre propriété. Ils peuvent l'acheter avec leur butin durement gagné, le prendre par la force, l'obtenir par chance d'une *[carte merveilleuse](dnd/om.php?vf=cartes-merveilleuses)* ou l'acquérir par d'autres moyens. Le tableau ci-dessus indique le coût d'entretien quotidien pour une telle propriété (le coût d'une petite résidence n'est pas inclus ici car il fait partie des dépenses liées au [[Dépenses|train de vie]]). Les frais d'entretien doivent être payés tous les 30 jours. Étant donné que les aventuriers passent une grande partie de leur temps en aventures, le personnel comprend un intendant qui peut effectuer des paiements en l'absence du groupe.
...
**Employés qualifiés et non qualifiés**. Les règles expliquent la différence entre un [[Dépenses|employé qualifié]] et un [[Dépenses|employé non qualifié]].

#### Entreprises

Une entreprise appartenant à un aventurier peut gagner suffisamment d'argent pour couvrir ses propres coûts d'entretien. Cependant, le propriétaire doit régulièrement s'assurer que tout se passe bien en s'occupant de l'entreprise entre deux aventures. Voir [[Temps morts\_1#entreprise|Gérer une entreprise]] plus haut sur cette page.

#### Garnisons

Les châteaux et les places fortes emploient des soldats (utilisez les statistiques des [vétérans](dnd/monstres.php?vf=veteran) et des [gardes](dnd/monstres.php?vf=garde)) pour les défendre. Les auberges, les avant-postes, les palais et les temples comptent sur des défenseurs moins expérimentés (utilisez les statistiques des [gardes](dnd/monstres.php?vf=garde)). Ces guerriers armés constituent l'essentiel des employés qualifiés d'une propriété.
