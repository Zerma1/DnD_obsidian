...
## [[6-guerrier|Archétypes martiaux]]
...
Au niveau 3, vous gagnez la maîtrise d'un [[1-outils|outil d'artisan]] de votre choix.
...
**Attaque menaçante**. Si vous touchez une créature lors d'une attaque avec une arme, vous pouvez dépenser un dé de supériorité pour tenter d’effrayer la cible. Ajoutez votre dé de supériorité aux dégâts, et la cible doit faire un jet de sauvegarde de Sagesse. En cas d'échec, la cible est [[11.0-etats|effrayée]] jusqu'à la fin de votre prochain tour.
