---
title: "Barbare"
source: "https://www.aidedd.org/regles/classes/barbare/"
tags:
  - dnd5  
  - regles
  - perso
...
Vous pouvez concevoir rapidement un barbare en suivant ces quelques suggestions. En premier lieu, la Force devrait être votre plus haute valeur de caractéristique, suivie par la Constitution. Ensuite, choisissez l'historique [[12-sauvageon|sauvageon]].
...
### [[1-barbare|Voie du guerrier totem]]
...
**Loup**. Vous gagnez les sens de chasseur d'un loup. Vous pouvez pister les autres créatures lorsque vous voyagez à un rythme rapide et vous pouvez vous déplacer discrètement lorsque vous voyagez à un rythme normal (voir [[8.0-aventure|Partir à l'aventure]]).  
...
### [[1-barbare|Voie de la magie sauvage]]
...
Traduit par toon, boblebuter et blueace