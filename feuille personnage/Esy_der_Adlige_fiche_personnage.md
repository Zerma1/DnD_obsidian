...
Issu de l'illustre et prestigieuse lignée des **der Adlige**, **Esy** a grandi dans le luxe, les salons dorés et les meilleures académies. La noblesse attendait de lui qu'il perpétue le nom familial à travers la diplomatie, la haute arcanologie ou la magistrature.

Cependant, derrière la façade immaculée de ses appartements de noble, son obsession pour l'anatomie, la mécanique d'horlogerie et les courants interdits de la nécromancie prit rapidement le dessus sur toute convention sociale. 
...
Recousant les assassins sans poser de questions et greffant des prothèses d'acier ou d'os sur les malfrats, il recyclait méthodiquement les cadavres pour alimenter ses composants et ces expérimentations, façonnant de sombres artefacts.
...
Son corps organique, privé de ses bras et de ses jambes, flotte en permanence dans un **réservoir étanche et fusiforme**, conçu pour fendre l'obscurité et glisser sans le moindre bruit. Cette cuve est remplie de **formol magique**, seul liquide capable de maintenir les tissus morts dans un état suffisamment stable pour permettre aux processus biomécaniques de continuer à fonctionner. Sa silhouette est extrêmement maigre et desséchée, presque réduite à une structure anatomique recouverte de peau parcheminée. Les vestiges de son ancienne apparence noble sont encore perceptibles dans les traits de son visage, mais ils sont déformés par la mort, la déshydratation et les innombrables interventions chirurgicales.

Sa **colonne vertébrale est entièrement exposée**. La peau et les tissus ont été retirés sur toute sa longueur, laissant apparaître les vertèbres sèches auxquelles sont directement fixés des connecteurs mécaniques, des câbles et des conduits. Une multitude de tuyaux et de fils s'échappent de chaque côté de sa colonne, certains pénétrant directement dans les os, d'autres alimentant les différents systèmes de l'exosquelette qui l'entoure.

Esy ne possède donc plus de membres naturels. À la place, son corps est maintenu et déplacé par un **exosquelette biomécanique** sophistiqué, directement relié à sa colonne vertébrale et à plusieurs points d'ancrage sur son thorax. Celui-ci lui fournit ses bras et ses jambes artificiels, mais également le support structurel nécessaire pour maintenir son corps dans une position fonctionnelle.

L'exosquelette n'a rien d'une armure classique ou lourde. Il s'agit davantage d'une **structure de contention, de survie et de locomotion furtive**, conçue pour se fondre dans les ténèbres. Des **plaques métalliques sombres aux finitions mates**, dotées de micro-structures destinées à absorber la lumière, protègent les organes encore fonctionnels, tandis que des articulations complexes et des câbles gainés remplacent les muscles et les tendons disparus.

Ses mouvements sont entièrement dépendants de cette machine. Lorsqu'il se déplace, l'exosquelette reproduit avec une précision spectrale les mouvements qu'Esy lui commande, tandis que son corps organique reste suspendu au centre de la structure. Afin de ne jamais trahir sa présence dans l'ombre, **l'ensemble des mécanismes est rigoureusement insonorisé, magnétisé et doté de joints d'isolation phonique** : les bruits de valves ou de servomoteurs sont totalement étouffés, ne laissant filtrer qu'un silence de mort lors de ses déplacements.
...
L'ensemble produit une impression profondément dérangeante et furtive : un **cadavre noble suspendu au cœur d'une machine spectrale**, incapable de vivre par lui-même mais rôdant dans l'ombre tel un fantôme d'acier.
...
| ----------------------------- | ---------------------- | ---------------- | ----------------- | -------------------------------------------------------- |
| **Arbalète légère**           | 24 / 96 m              | +4               | 1d8 + 2 perforant | Deux mains, munition, chargement                         |
| **Dagues chirurgicales (x2)** | 1,50 m (lancée 6/18 m) | +4               | 1d4 + 2 perforant | Finesse, lancer, légère                                  |
| **Contact Glacial**           | 36 m                   | +4               | 1d8 nécrotique    | Sort à distance (action)                                 |
| **Voile d'ombre**             | Personnelle            | —                | Invisibilité      | Action bonus (pénombre/obscurité, 1×/repos long)         |
| **Précision Prédatrice**      | —                      | —                | +4 nécrotique     | Sur cible surprise/inactive au round 1 (bloque réaction) |
